...
namespace NSInputBindingName
{
	...
	DECLARE_CONST_FNAME(WeaponControlA)
	DECLARE_CONST_FNAME(WeaponControlB)
	DECLARE_CONST_FNAME(WeaponControlC)
	DECLARE_CONST_FNAME(WeaponControlD)
	DECLARE_CONST_FNAME(WeaponControlE)
	DECLARE_CONST_FNAME(WeaponControlF)
	DECLARE_CONST_FNAME(Pause)
	DECLARE_CONST_FNAME(ESC)
}