...
namespace NSActionData
{
	...
	DECLARE_NAMESPACE_CONST_FNAME_DATACLASS(DestAltitude_Min, UDataFloat)
	DECLARE_NAMESPACE_CONST_FNAME_DATACLASS(DestAltitude_Max, UDataFloat)
	...
	DECLARE_NAMESPACE_CONST_FNAME_DATACLASS(keepDistanceXY_Min, UDataFloat)
	DECLARE_NAMESPACE_CONST_FNAME_DATACLASS(keepDistanceXY_Max, UDataFloat)
	...
	DECLARE_NAMESPACE_CONST_FNAME_DATACLASS(CircleAroundDuration, UDataFloat)
